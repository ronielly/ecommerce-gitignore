...
namespace Ecommerce.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CitiesId,Name,DepartamentsId")] Cities cities)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CitiesId,Name,DepartamentsId")] Cities cities)
        {
            if (ModelState.IsValid)
            {
